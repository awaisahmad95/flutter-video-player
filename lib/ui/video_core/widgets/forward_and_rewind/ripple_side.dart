  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      ...
      painter: side == RippleSide.left
          ? _RippleLeftPainter(Colors.white.withAlpha(71))
          : _RippleRightPainter(Colors.white.withAlpha(71)),
      child: Padding(
        padding: side == RippleSide.left ? EdgeInsets.only(right: 10) : EdgeInsets.only(left: 10),
        child: Column(
